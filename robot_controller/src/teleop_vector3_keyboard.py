...
if __name__=="__main__":
	...
	base_pub = rospy.Publisher('robot1/base_test', Vector3)
	arm_pub1 =  rospy.Publisher('robot1/arm_initialize', Vector3)
	arm_pub2 =  rospy.Publisher('robot1/arm', Vector3)
	arm_pub3 = rospy.Publisher('robot1/armKB',Vector3)
	arm_laser_pub = rospy.Publisher('robot1/laser',Vector3)
