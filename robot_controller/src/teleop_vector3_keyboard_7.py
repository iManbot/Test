...
if __name__=="__main__":
	...
	base_pub = rospy.Publisher('robot7/base_test', Vector3)
	arm_pub1 =  rospy.Publisher('robot7/arm_initialize', Vector3)
	arm_pub2 =  rospy.Publisher('robot7/arm', Vector3)
	arm_pub3 = rospy.Publisher('robot7/armKB',Vector3)
	arm_laser_pub = rospy.Publisher('robot7/laser',Vector3)
	rospy.init_node('teleop_vector3_keyboard_7')
