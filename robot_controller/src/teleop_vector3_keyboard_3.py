...
if __name__=="__main__":
	...
	base_pub = rospy.Publisher('robot3/base_test', Vector3)
	arm_pub1 =  rospy.Publisher('robot3/arm_initialize', Vector3)
	arm_pub2 =  rospy.Publisher('robot3/arm', Vector3)
	arm_pub3 = rospy.Publisher('robot3/armKB',Vector3)
	arm_laser_pub = rospy.Publisher('robot3/laser',Vector3)
	rospy.init_node('teleop_vector3_keyboard_3')
